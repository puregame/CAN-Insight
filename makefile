...
TARGET_NAME      := CANLogger
BOARD_ID         := TEENSY41

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\MATTHE~1\DOCUME~1\Arduino\LIBRAR~1
LIBS_SHARED      := TeensyTimerTool FlexCAN_T4 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := ArduinoHttpClient ArduinoJson EEPROM SdFat SPI Time WiFi101 
